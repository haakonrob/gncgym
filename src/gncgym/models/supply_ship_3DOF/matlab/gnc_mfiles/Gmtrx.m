function get_g = Gmtrx(nabla,A_wp,GMT,GML,r_p)
% get_g = GMTRX(nabla,A_wp,GMT,GML,r_gp) computes the 6x6 system spring stiffness matrix get_g
...
get_g = Hmtrx(r_p)' * G_CO * Hmtrx(r_p);